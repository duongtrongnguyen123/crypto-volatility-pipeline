...
\begin{frame}{ROC Curves}
  \begin{figure}
    \centering
    \includegraphics[width=0.45\linewidth]{figures/fig11_roc_curve.png}
...
\begin{frame}{Calibration Analysis}
  \begin{columns}[t]
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.75\linewidth]{figures/fig3_calibration.png}
    \end{figure}
    \column{0.5\textwidth}
    \textbf{Key Findings}
    \begin{itemize}
...
\begin{frame}{Per-Asset Predictive Power}
  \begin{columns}[t]
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.7\linewidth]{figures/fig7_per_asset.png}
    \end{figure}
    \column{0.48\textwidth}
    \textbf{Observations}
    \begin{itemize}
...
\begin{frame}{Incremental Value — TRR vs Price Momentum}
  \begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/fig9_incremental_value.png}
...
\begin{frame}{Ensemble Methods Comparison}
  \begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/fig15_ensemble_methods.png}
...
% SLIDE: LSTM RESULTS
% =========================================================================
\begin{frame}{LSTM Volatility Model — Predictions}
  \begin{columns}[t]
    \column{0.5\textwidth}
    \begin{figure}
      \centering
      \includegraphics[width=0.95\linewidth]{pred_vs_actual.png}
...
\begin{frame}{LSTM Volatility Model — Performance}
  \begin{columns}[t]
    \column{0.5\textwidth}
...
\begin{frame}{Economic Backtest — TRR Strategy vs Buy \& Hold}
  \begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{backtest_equity.png}
...
\begin{frame}{Risk-Adjusted Performance Metrics}
  \begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figures/fig14_sharpe_drawdown.png}
  \end{figure}

...
DEFAULT_START, DEFAULT_END = "2021-07-01", "2021-12-31"
SMOKE_START, SMOKE_END = "2020-02-20", "2020-03-20"
# Both targets run in one GPU session (model load is the cost) unless overridden.
TARGET_MODES = os.environ.get("TARGET_MODES", "crash").split(",")
USE_RAG = os.environ.get("USE_RAG", "1") == "1"  # case-based few-shot retrieval

...
Dù vậy, \textbf{rủi ro crash} — tức rủi ro đuôi trái (left-skewed tail-risk) — lại là một hiện tượng khác biệt. Mặc dù các ngày giao dịch biến động mạnh chỉ chiếm khoảng 5\% tổng số ngày giao dịch, nhưng chúng lại đóng góp tới 19\% tổng mức dịch chuyển của thị trường. Các cuộc crash thường được báo trước hoặc đồng hành bởi sự lây lan tâm lý sợ hãi trên mặt báo và các sự kiện chấn động mang tính dây chuyền. Như thấy ở Hình \ref{fig:crash_timeline}, các đợt sụt giảm mang tính cụm (volatility clustering) do sự lây lan thông tin. Sự lan truyền thông tin tiêu cực thường có độ trễ do tâm lý đám đông, tạo ra một cửa sổ cơ hội ngắn để dự báo. Do đó, việc xây dựng mô hình dự báo crash rủi ro đuôi là một nhiệm vụ khả thi và có cơ sở khoa học hơn nhiều so với dự báo hướng giá hằng ngày.
...
\begin{enumerate}
    ...
    \item \textbf{Dữ liệu lớn chưa hẳn đã tốt hơn dữ liệu tinh:} Corpus FNSPID khổng lồ (0.652 trên toàn cục, 0.763 trên cửa sổ COVID) không thể vượt qua bộ Analyst-ratings nhỏ bé nhưng đã được tuyển chọn khắt khe (0.847 trên cửa sổ COVID). 
...
Thay vì dự báo cả danh mục, chúng tôi đã ép mô hình xuất ra dự báo crash cho từng đồng tiền mã hóa. 

...
\title{\textbf{BÁO CÁO MÔN HỌC DỮ LIỆU LỚN (BIG DATA)}\\ \vspace{1cm} \huge \textbf{Suy luận Quan hệ và Thời gian của Mô hình Ngôn ngữ Lớn để Dự đoán Crash Giá Cổ phiếu và Crypto}\\ \vspace{0.5cm} \large (Temporal Relational Reasoning of LLMs for Stock Crash Prediction)}
\author{\vspace{1cm}\\
